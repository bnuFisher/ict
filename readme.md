...
这个项目大约是一年前的现在完成的，当时我初学Python不到半年，对很多概念都一知半解，不知道虚拟开发环境是何物，不确定是否应该深入学习爬虫，对未来的职业方向也缺乏清晰的规划，只是学习Python让我隐约感到了另一种职业可能性。现在回过头来看当初的代码，简直不能直视。但我依然打算保留它们，当作是成长的见证。
